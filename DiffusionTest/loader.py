...
def get_loaders(name: str, batch_sz: int, img_sz: int):
    ...
    assert name in [
        ...
        "cifar10",
        "fashion",
    ], "Dataset name must be one of 'celeb', 'bridge', 'cifar10', or 'fashion'"
    if name == "celeb":
        ...
        dataset = datasets.ImageFolder(celeb_data_dir, transform=custom_transform)
        ...
        trainloader = DataLoader(
            trainset, batch_size=batch_sz, shuffle=True, num_workers=2
        )
